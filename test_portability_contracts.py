...
SCRIPT_PATHS = [
    ...
    REPO_ROOT / "demo" / "audit_check.R",
    REPO_ROOT / "demo" / "semantic_check.R",
    REPO_ROOT / "demo" / "stability_check.R",
    REPO_ROOT / "demo" / "nma_arbiter_demo.R",
    REPO_ROOT / "demo" / "final_polish.R",
    REPO_ROOT / "demo" / "pilot_phase.R",
